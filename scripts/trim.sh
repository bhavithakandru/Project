...
function trim {
    trimmomatic PE \
    -threads 1 -phred33 \
    ../data/SRR21003528_1.fastq \
    ../data/SRR21003528_2.fastq \
    ../data/trimmed/cholerae.R1.paired.fastq \
    ../data/trimmed/cholerae.R1.unpaired.fastq \
    ../data/trimmed/cholerae.R2.paired.fastq \
    ../data/trimmed/cholerae.R2.unpaired.fastq \
    HEADCROP:0 \
